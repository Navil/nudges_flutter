...
class ExpansionPanel {
  ...
  ExpansionPanel({
    ...
    @required this.body,
    @required this.providedExpandRow,
...
class ExpansionPanelRadio extends ExpansionPanel {
  ...
  ExpansionPanelRadio({
    ...
    @required Row providedExpandRow
  }) : assert(value != null),
        super(body: body, headerBuilder: headerBuilder, providedExpandRow: providedExpandRow);
        ...
        children: <Widget>[
         ...
         FlatButton(
            padding: EdgeInsets.only(top:10.0),
             onPressed: () {
               _handlePressed(this._isChildExpanded(index), index);
             },
           child: Column(
               children: [child.providedExpandRow,
            Icon(this._isChildExpanded(index)?Icons.expand_less:Icons.expand_more, color: Theme.of(context).primaryColor)
            ])
         ),
        ],
      );
